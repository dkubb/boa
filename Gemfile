...
group :development, :test do
  ...
  gem 'rubocop-minitest',    '~> 0.34.1'                  # RuboCop extension specific to Minitest
  gem 'rubocop-performance', '~> 1.20.0'                  # RuboCop extension for enforcing performance best practices
  ...
  gem 'sorbet',              '~> 0.5.11156'               # Type checker for Ruby
  gem 'tapioca',             '~> 0.11.13', require: false # Generate RBI files for gems and standard library
